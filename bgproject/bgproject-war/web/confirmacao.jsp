            ...
            <div id="descprod" style='border:0;width: 700px;height: 100%;float:left;margin: 0 auto;margin-left: 150px;margin-top: 70px;'>
                ...
                <div class="infoprodconteudo">
                    <div style="width: auto;height: auto; padding: 15px 5px 15px 10px;">
                     ...
                     <div style="width: auto;height: auto; padding: 15px 5px 15px 10px;">
                     &bull; <span id="infoprodtopic">CEP: </span><span id="textodesc"><c:out value="${enderecop.getCep()}"/></span>
                        <br>&bull; <span id="infoprodtopic">ENDEREÇO: </span><span id="textodesc"><c:out value="${enderecop.getEndereco()}"/></span>
                        <br>&bull; <span id="infoprodtopic">CIDADE: </span><span id="textodesc"><c:out value="${enderecop.getCidade()}"/></span>                                            
                        </div>
